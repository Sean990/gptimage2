...
const routes = [
  ...
  { path: '/my-orders', name: 'my-orders', component: MyOrdersView, meta: { title: '个人中心 | GPT Image 2' } },
  { path: '/my-credits', name: 'my-credits', component: MyOrdersView, meta: { title: '我的积分 | GPT Image 2' } },
  { path: '/my-invites', name: 'my-invites', component: MyOrdersView, meta: { title: '我的邀请 | GPT Image 2' } },
  { path: '/profile', name: 'profile', component: MyOrdersView, meta: { title: '个人资料 | GPT Image 2' } },
