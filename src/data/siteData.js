...
export const features = [
  ...
  ['基于参考图继续编辑', '用自然语言修改局部元素、背景、服饰和主体关系，减少整张重做的返工。'],
